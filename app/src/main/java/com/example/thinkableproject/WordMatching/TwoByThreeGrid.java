...
public class TwoByThreeGrid extends AppCompatActivity {
    ...
    public void topLeftWhenClickedB(View view) {
        whenClicked(0);
    }

    public void topRightWhenClickedB(View view) {
        whenClicked(1);
    }

    public void middleLeftWhenClickedB(View view) {
        whenClicked(2);
    }

    public void middleRightWhenClickedB(View view) {
        whenClicked(3);
    }

    public void bottomLeftWhenClickedB(View view) {
        whenClicked(4);
    }

    public void bottomRightWhenClickedB(View view) {
        whenClicked(5);
    }
}
