...
public class TwoByFourGrid extends AppCompatActivity {
    ...
    public void Btn2x4A1WhenClicked(View view) {
        whenClicked(0);
    }

    public void Btn2x4A2WhenClicked(View view) {
        whenClicked(1);
    }

    public void Btn2x4B1WhenClicked(View view) {
        whenClicked(2);
    }

    public void Btn2x4B2WhenClicked(View view) {
        whenClicked(3);
    }

    public void Btn2x4C1WhenClicked(View view) {
        whenClicked(4);
    }

    public void Btn2x4C2WhenClicked(View view) {
        whenClicked(5);
    }

    public void Btn2x4D1WhenClicked(View view) {
        whenClicked(6);
    }

    public void Btn2x4D2WhenClicked(View view) {
        whenClicked(7);
    }
