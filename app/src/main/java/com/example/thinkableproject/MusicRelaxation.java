...
public class MusicRelaxation extends AppCompatActivity implements MusicAdapter.OnNoteListner {
        ...
        FirebaseMessaging.getInstance().subscribeToTopic("Music")
                .addOnCompleteListener(new OnCompleteListener<Void>() {
                    ...
                    public void onComplete(@NonNull Task<Void> task) {
                        ...
                        Log.d("TAG", msg);
                        Toast.makeText(MusicRelaxation.this, msg, Toast.LENGTH_SHORT).show();
                    }
                });
